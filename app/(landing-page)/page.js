  ...
  return (
    <div className="container mx-auto p-8 pb-20 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <div className="relative">
        ...
        <h1 className="text-4xl font-bold tracking-light">Software Engineer and <span className="block text-purple-600">Data-Base Handler</span> </h1>
        <p className="mt-6 text-xl text-gray-300 leading-8">Crafting a Responsive Website for Real Estate Professionals | Innovating with AI solutions for the future of Property Tech </p>
        <div className="flex mt-10 gap-4">
          <button className="px-8 py-3 rounded-lg bg-purple-600 text-white font-medium hover:bg-purple-500">About Me</button>
          <button className="px-8 py-3 rounded-lg border border-gray-600 hover:border-purple-500 font-medium">Contact Me</button>
        </div>
      </div>
      <ProjectSection/>
    </div>
